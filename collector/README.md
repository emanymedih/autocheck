...
HTML pilot применяется только для согласованной технической проверки с потенциальным партнёром. Production-поток должен перейти на разрешённый feed/API продавца. Адаптер не предусматривает обход CAPTCHA, авторизации или ограничений доступа.
